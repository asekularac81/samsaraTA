...
public class UserNavigationTest extends BaseTest {
  ...
  public void testAdminUserNavigation() {
    ...
    Assert.assertEquals(homePage.getPageTitle(), CommonStrings.HOME_PAGE_TITLE, "Wrong page Title on Home Page!");
    ...
    softAssert.assertEquals(practicePage.getUsersTabTitle(), CommonStrings.USERS_TAB_TITLE, "Wrong Users Tab Title on Navigation Bar!");
    softAssert.assertEquals(practicePage.getHeroesTabTitle(), CommonStrings.HEROES_TAB_TITLE, "Wrong Heroes Tab Title on Navigation Bar!");
    softAssert.assertEquals(practicePage.getGalleryTabTitle(), CommonStrings.GALLERY_TAB_TITLE, "Wrong Gallery Tab Title on Navigation Bar!");
    softAssert.assertEquals(practicePage.getAPITabTitle(), CommonStrings.API_TAB_TITLE, "Wrong API Tab Title on Navigation Bar!");
    softAssert.assertEquals(practicePage.getPracticeTabTitle(), CommonStrings.PRACTICE_TAB_TITLE, "Wrong Practice Tab Title on Navigation Bar!");
    ...
    Assert.assertEquals(practicePage.getLogoutLinkTitle(), CommonStrings.LOGOUT_LINK_TITLE, "Wrong Logout Link Title on Practice Page!");
