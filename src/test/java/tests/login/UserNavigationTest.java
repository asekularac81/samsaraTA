...
public class UserNavigationTest extends BaseTest {
  ...
  public void setUpTest () {
    ...
    driver = setupDriver();
    sUserName = PropertiesUtils.getUserUsername();
  ...
  public void testAdminUserNavigation() {
    ...
    log.info("Enter user username and password.");
    ...
    log.info("Verify Admin tab is not displayed to User.");
    Assert.assertFalse(practicePage.isAdminTabDisplayed(),"Admin Tab is should NOT be displayed on for User!");

    log.info("Verify Tab names in Navigation Bar!");
    SoftAssert softAssert = new SoftAssert();
    softAssert.assertEquals(practicePage.getUsersTabTitle(), CommonStrings.getLocaleString(CommonStrings.USERS_TAB_TITLE), "Wrong Users Tab Title on Navigation Bar!");
    softAssert.assertEquals(practicePage.getHeroesTabTitle(), CommonStrings.getLocaleString(CommonStrings.HEROES_TAB_TITLE), "Wrong Heroes Tab Title on Navigation Bar!");
    softAssert.assertEquals(practicePage.getGalleryTabTitle(), CommonStrings.getLocaleString(CommonStrings.GALLERY_TAB_TITLE), "Wrong Gallery Tab Title on Navigation Bar!");
    softAssert.assertEquals(practicePage.getAPITabTitle(), CommonStrings.getLocaleString(CommonStrings.API_TAB_TITLE), "Wrong API Tab Title on Navigation Bar!");
    softAssert.assertEquals(practicePage.getPracticeTabTitle(), CommonStrings.getLocaleString(CommonStrings.PRACTICE_TAB_TITLE), "Wrong Practice Tab Title on Navigation Bar!");
    ...
    Assert.assertEquals(practicePage.getLogoutLinkTitle(), CommonStrings.getLocaleString(CommonStrings.LOGOUT_LINK_TITLE), "Wrong Logout Link Title on Practice Page!");
    loginPage = practicePage.clickLogoutLink();
